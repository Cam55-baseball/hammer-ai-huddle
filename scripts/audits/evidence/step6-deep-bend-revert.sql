...
update public.wk_movement_catalog set
  ...
  season_legality = season_legality
    || jsonb_build_object('in_season', (slug in ('kot_lunge','lift_kot_sissy_squat','lift_patrick_step','lift_poliquin_stepup','poliquin_step_up','slide_lunge')),
                          'post_season', (slug in ('kot_lunge','lift_kot_sissy_squat','lift_patrick_step','lift_poliquin_stepup','poliquin_step_up','slide_lunge')))
where slug in (
  'lift_deficit_deadlift','lift_jefferson_curl','lift_kot_sissy_squat','lift_patrick_step',
  'lift_paused_front_squat','lift_poliquin_stepup','kot_lunge','poliquin_step_up','slide_lunge'
);
