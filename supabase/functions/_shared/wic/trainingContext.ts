// supabase/functions/_shared/wic/trainingContext.ts — Phase 4 SERVER MIRROR.
//
// Shape-parity with src/lib/wic/trainingContext.ts. Any change to one file
// MUST be mirrored in the other. Edge functions are the sole owners of
// context RESOLUTION; the client mirror exists so cards can read/type-check
// the resulting `training_context` object without server imports.
