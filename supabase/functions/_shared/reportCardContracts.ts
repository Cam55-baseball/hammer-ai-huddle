...
// ------- SP (Softball Pitching / windmill) — no baseball clone -------
/**
 * 13 report-card tiles backed by 15 persisted metric keys. Checkpoints A–L
 * trace to the 2025 peer-reviewed windmill-pitching clinical review. The
 * source supplies the checkpoints, SFC foot-angle band, and stride bands;
 * other numeric thresholds are Hammer-proposed starting tolerances.
 */
