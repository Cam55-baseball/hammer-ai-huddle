ALTER TABLE public.wk_generation_diagnostics
  ...
  ADD COLUMN IF NOT EXISTS system_state_hash text,
  ADD COLUMN IF NOT EXISTS engine_signature_hashes jsonb,
  ADD COLUMN IF NOT EXISTS why_v2_hash text,
  ADD COLUMN IF NOT EXISTS validator_aggregate_hash text,
  ADD COLUMN IF NOT EXISTS global_invariant_status text;
