...
ALTER TABLE public.wk_generation_diagnostics
  ADD COLUMN IF NOT EXISTS resolved_season_phase text,
  ADD COLUMN IF NOT EXISTS resolved_day_type text,
  ADD COLUMN IF NOT EXISTS context_version text,
  ADD COLUMN IF NOT EXISTS legality_profile_id text,
  ADD COLUMN IF NOT EXISTS recovery_profile_id text,
  ADD COLUMN IF NOT EXISTS adaptation_profile_id text,
  ADD COLUMN IF NOT EXISTS context_validation_outcome text;
