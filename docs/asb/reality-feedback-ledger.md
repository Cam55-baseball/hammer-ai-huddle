...
| RFL-089 | Phase 0.8 — §16 Compression Pass — executed on `docs/asb/report-card-constitution.md` (v0.10). §0.26 added: every §16 item (A1–K7) classified A (fully resolved by doctrine), B (derived default with citation; owner may override at §17 fill), or C (true residual owner decision). Counts: original §16 = 46 questions; out of V1 scope = 3 (B4 Throwing, B5 Softball Slap, K7 Throwing-standards verbatim); V1-applicable = 43; auto-resolved A = 15 (A1, B6, C2, D1, D6, E1, E3, F1, F2, I1, I3, I4, K1, K2, K4); auto-resolved B = 25 (A2, A3, B1, B3, C4, D2, D3, D4, D5, E2, E4, F3, G1, G2, H1, H2, I2, J1, J2, J3, J4, J5, K3, K5, K6); true residual C = 3 (B2 Pitching Posture+Stride mapping; C1 BP engine weights ratify/override; C3 Developmental vs Advanced age cut-offs). K7 explicitly removed from V1 §18 blocking status — remains a §6 Throwing drafting flag but does not gate V1 ratification. §16 list rewritten in place with `[§0.26 = A/B/C]` classification stamps per item; §18 exit criteria split into V1 (BP+BH per CDR-15) requiring only B2/C1/C3 + §17 BP+BH fill + RFL ratification, and full multi-discipline ratification requiring K7 verbatim text + B4/B5 when Throwing/Softball enter scope. §0.25 §G summary marked superseded by §0.26 §G. Version bumped v0.9 → v0.10; STATUS line updated to `§0 RATIFIED — §16 COMPRESSED (3 owner items remain) / §17 OPEN`. **No new audit. No new CDRs. No new constitutional discovery. No new governance phase.** Pure compression of existing §16 against ratified §0 doctrine + ratified CDRs. All prior implementation prohibitions remain in force; implementation NOT authorized. Owner workload reduced from 46 → 3 V1 questions; awaiting Q1/Q2/Q3 answers per §0.26 §F. Subordinate to Eternal Laws, RR-1…RR-10, RW-1…RW-10, and every invariant family across ASB Phases 1–160. | high | Open — awaiting owner answers to §0.26 §F Q1/Q2/Q3 (V1 scope: Baseball Pitching + Baseball Hitting) | No code, schema, UI, route, edge-function, registry, removal, or token change in this phase. Document is `STATUS: §0 RATIFIED — §16 COMPRESSED (3 owner items remain) / §17 OPEN` v0.10. RFL-073…RFL-088 remain subordinate to §18 V1 ratification. |
