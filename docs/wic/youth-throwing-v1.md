...
- **Pitcher who also catches:** combined budget = stricter of the two × 0.70 (was 0.85). Plain line to athlete and staff: about three times the arm-injury rate in published work (correlation, not a prediction).
