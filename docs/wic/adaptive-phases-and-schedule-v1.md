> **Live status (E2E WP6, 2026-09-25 17:45 UTC):** LIVE. adaptive_phases ON (all); wk-generate-daily stamps every row with the athlete's phase (verified 17/17 rows, 2026-09-25).
