...
describe('buildCalendarEvents', () => {
  ...
  it('excludes logs whose parent template is missing or soft-deleted', () => {
    const events = buildCalendarEvents({
      ...baseInput(),
      templates: [
        { id: 'live', title: 'Live', deleted_at: null },
        { id: 'gone', title: 'Gone', deleted_at: '2025-01-01' },
      ],
      logs: [
        { id: 'l1', entry_date: '2025-01-15', template_id: 'live', completed: false },
        { id: 'l2', entry_date: '2025-01-15', template_id: 'gone', completed: false },
        { id: 'l3', entry_date: '2025-01-15', template_id: 'orphan', completed: false },
      ],
    });
    expect(events.map((e) => e.sourceId)).toEqual(['l1']);
  });
