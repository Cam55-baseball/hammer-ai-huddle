...
const ATHLETE_GAPS: ReadonlyArray<KnowledgeGap> = [
  ...
  },
  {
    ...
    audience: "athlete",
    priority: 122,
    question: "Walk me through your pre-game mental funnel — from the ride to the field to the first pitch.",
    helper: "Works for any position. Think in stages: (1) arrival mindset, (2) warm-up focus, (3) dugout / on-deck reset, (4) the last 10 seconds before the play. What actually works for you — cues, breathing, self-talk, visualization?",
    inputKind: "text",
