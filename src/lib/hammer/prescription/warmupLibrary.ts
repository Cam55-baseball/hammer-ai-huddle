...
export const WARMUP_LIBRARY: WarmupDrill[] = [
  ...
  { slug: "wu_barefoot_towel_scrunch", name: "Barefoot towel scrunch (foot fascia)", role: "tissue_prep", setup: "towel under bare foot", cue: "drag toward you with toes — arch stays lifted", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "30 sec per foot" },
  { slug: "wu_calf_softball_pin", name: "Soleus ball pin (calf ECM hydration)", role: "tissue_prep", cue: "pin, then dorsiflex/plantarflex the ankle", gameDayLegal: true, minLifecycle: "beginner", source: "internal", baseDose: "45 sec per side" },

  // Fascial rotation
  { slug: "wu_spinal_wave_standing", name: "Standing spinal wave", role: "fascial_rotation", cue: "sequence segment by segment — no muscling", gameDayLegal: true, minLifecycle: "beginner", source: "internal", baseDose: "6 reps each direction", beginnerDose: "4 reps each direction" },
  { slug: "wu_arm_line_spiral", name: "Arm-line fascial spiral", role: "fascial_rotation", setup: "half-kneeling", cue: "reach across body, let ribcage rotate through", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "6 per side" },
  { slug: "wu_thoracic_windmill", name: "Thoracic windmill (side-lying open book)", role: "fascial_rotation", setup: "side-lying, knees stacked at 90°", cue: "reach long, exhale into the twist", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "8 per side" },
  { slug: "wu_thread_the_needle_slow", name: "Thread-the-needle slow flow", role: "fascial_rotation", cue: "quadruped rotate — chase length not depth", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "6 per side" },
  { slug: "wu_lateral_line_reach", name: "Lateral line reach + side bend", role: "fascial_rotation", cue: "long from foot to fingertip — feel the whole side stretch", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "5 per side" },
  ...
  { slug: "wu_spiderman_reach", name: "Spiderman + rotational reach", role: "mobility_joint", cue: "reach the top hand for the ceiling — eyes chase it", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "5 per side" },
  { slug: "wu_frog_rock", name: "Frog stretch rock-back", role: "mobility_joint", setup: "quadruped, knees wide", cue: "rock slow, keep back flat", gameDayLegal: true, minLifecycle: "beginner", source: "internal", baseDose: "8 slow rocks" },
  { slug: "wu_hip_airplane", name: "Hip airplanes (SL hinge + rotation)", role: "mobility_joint", cue: "square the hips, then open, then square — no wobble", gameDayLegal: true, minLifecycle: "intermediate", source: "internal", baseDose: "5 per side", beginnerDose: "3 per side with wall support" },
  { slug: "wu_adductor_rock", name: "Adductor rock-back", role: "mobility_joint", setup: "half-kneeling, one leg extended lateral", cue: "hips back and down, chest tall", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "8 per side" },
  { slug: "wu_couch_stretch_active", name: "Active couch stretch + posterior tilt", role: "mobility_joint", setup: "rear foot elevated behind you", cue: "squeeze glute, tuck tail, breathe", gameDayLegal: true, minLifecycle: "beginner", source: "internal", baseDose: "30 sec + 5 reps per side" },
  { slug: "wu_tspine_open_book", name: "T-spine open book", role: "mobility_joint", cue: "reach long, follow with your eyes", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "6 per side" },
  { slug: "wu_wall_hip_flexor_slide", name: "Wall-assisted hip flexor slide", role: "mobility_joint", cue: "posterior tilt drives the stretch, not the lean", gameDayLegal: true, minLifecycle: "beginner", source: "internal", baseDose: "5 per side" },

  // Activation
  { slug: "wu_miniband_lat_walk", name: "Mini-band lateral walk", role: "activation", setup: "light mini-band above knees", cue: "knees track toes, hips stay level", stopIf: "knee tracking pain", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "2 x 10 steps each way" },
  { slug: "wu_miniband_monster_walk", name: "Mini-band monster walk", role: "activation", setup: "band above knees", cue: "athletic stance, small steps, tension the whole time", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "2 x 8 forward + 8 back" },
  { slug: "wu_glute_bridge_walkout", name: "Glute bridge walkout", role: "activation", setup: "hips up, walk feet out then back in", cue: "hips stay level, don't let one side drop", gameDayLegal: true, minLifecycle: "beginner", source: "internal", baseDose: "2 x 6 steps" },
  { slug: "wu_deadbug_band_press", name: "Dead-bug w/ band overhead press iso", role: "activation", cue: "ribs locked down, exhale as leg extends", gameDayLegal: true, minLifecycle: "beginner", source: "internal", baseDose: "2 x 5 per side" },
  { slug: "wu_bird_dog_slow", name: "Bird-dog slow tempo", role: "activation", cue: "no hip shift when the leg extends", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "2 x 5 per side" },
  { slug: "wu_prone_hip_ext_iso", name: "Prone glute-only hip extension", role: "activation", cue: "lift the leg with the glute, not the low back", gameDayLegal: true, minLifecycle: "beginner", source: "internal", baseDose: "2 x 6 per side" },
  ...
  { slug: "wu_tennis_ball_reaction_toss", name: "Tennis ball reaction toss", role: "weightless_coordination", setup: "facing wall or partner 6-10 ft away", cue: "catch it on the first bounce — no extra steps", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "2 x 30 sec", beginnerDose: "2 x 20 sec", eliteDose: "1 x 30 sec" },
  { slug: "wu_tennis_ball_self_rally", name: "Tennis ball self-rally", role: "weightless_coordination", setup: "small space, one hand only", cue: "bounce, catch, repeat — smooth rhythm", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "2 x 30 sec", beginnerDose: "2 x 20 sec", eliteDose: "1 x 30 sec" },
  { slug: "wu_tennis_ball_one_hand_catch", name: "Tennis ball one-hand catch", role: "weightless_coordination", setup: "toss and catch with one hand", cue: "no bobbling — stick the catch", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "2 x 12 per side", beginnerDose: "2 x 8 per side", eliteDose: "1 x 12 per side" },
  { slug: "wu_tennis_ball_cross_body_catch", name: "Tennis ball cross-body catch", role: "weightless_coordination", cue: "reach across the midline — let the ribcage rotate", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "2 x 10 per side", beginnerDose: "2 x 6 per side", eliteDose: "1 x 10 per side" },
  { slug: "wu_tennis_ball_clap_catch", name: "Tennis ball clap-catch", role: "weightless_coordination", cue: "toss, clap, catch — one bounce", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "2 x 10", beginnerDose: "2 x 6", eliteDose: "1 x 10" },
  { slug: "wu_scarf_juggle", name: "Scarf juggling (2-3 scarves)", role: "weightless_coordination", cue: "toss slowly, track the arc with eyes", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "3 x 30 sec", beginnerDose: "2 x 30 sec", eliteDose: "1 x 30 sec" },
  { slug: "wu_scarf_cross_body_catch", name: "Scarf cross-body catch", role: "weightless_coordination", setup: "Stand tall with one light silk/juggling scarf (or a light cloth napkin) held in your RIGHT hand at hip level. Feet shoulder-width, hips facing forward — they stay facing forward the entire drill.", cue: "Toss the scarf up and across your body toward your LEFT shoulder so it floats above head height, then let it fall. Reach across your midline and catch it in your LEFT hand before it drops below your waist. Immediately toss it back across to the RIGHT and catch with the RIGHT hand. That is 1 rep per side. Keep hips square — only the arms and ribcage rotate. Slow, smooth, no missed catches.", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "2 sets x 8 catches per side", beginnerDose: "2 sets x 5 catches per side", eliteDose: "1 set x 8 catches per side" },
  { slug: "wu_scarf_toss_and_move", name: "Scarf toss and move under", role: "weightless_coordination", cue: "toss high, shuffle under it, catch at the peak", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "2 x 6", beginnerDose: "2 x 4", eliteDose: "1 x 6" },
  { slug: "wu_scarf_one_hand_snatch", name: "Scarf one-hand snatch", role: "weightless_coordination", cue: "snatch it out of the air with one hand — quick exchange", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "2 x 8 per side", beginnerDose: "2 x 5 per side", eliteDose: "1 x 8 per side" },
  { slug: "wu_balloon_keep_up", name: "Balloon keep-up", role: "weightless_coordination", setup: "hand or forearm only", cue: "keep it alive with minimal force — read the float", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "2 x 45 sec", beginnerDose: "2 x 30 sec", eliteDose: "1 x 45 sec" },
  { slug: "wu_balloon_hand_switch", name: "Balloon hand-switch keep-up", role: "weightless_coordination", cue: "alternate hands, no double taps", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "2 x 30 sec", beginnerDose: "2 x 20 sec", eliteDose: "1 x 30 sec" },
  { slug: "wu_balloon_partner_volley", name: "Balloon partner volley", role: "weightless_coordination", setup: "with a partner, no spiking", cue: "soft, controlled, read the arc", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "2 x 45 sec", beginnerDose: "2 x 30 sec", eliteDose: "1 x 45 sec" },
  { slug: "wu_beanbag_toss_and_catch", name: "Beanbag toss and catch", role: "weightless_coordination", cue: "catch it soft — no sound on landing", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "2 x 12", beginnerDose: "2 x 8", eliteDose: "1 x 12" },
  { slug: "wu_beanbag_balance_walk", name: "Beanbag balance walk", role: "weightless_coordination", setup: "beanbag on top of the head", cue: "tall posture, walk heel-to-toe", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "2 x 20 yds", beginnerDose: "2 x 10 yds", eliteDose: "1 x 20 yds" },
  { slug: "wu_beanbag_foot_flip", name: "Beanbag foot flip", role: "weightless_coordination", cue: "flip it up with the foot, catch it with the same-side hand", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "2 x 6 per side", beginnerDose: "2 x 4 per side", eliteDose: "1 x 6 per side" },
  { slug: "wu_reaction_drop_catch", name: "Reaction drop-catch", role: "weightless_coordination", setup: "partner drops the ball without warning", cue: "explode the hand — catch before the second bounce", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "2 x 10", beginnerDose: "2 x 6", eliteDose: "1 x 10" },
  { slug: "wu_coin_finger_roll", name: "Coin finger roll", role: "weightless_coordination", setup: "coin on back of hand, flip and catch", cue: "quiet fingers, smooth arc", gameDayLegal: true, minLifecycle: "beginner", source: "internal", baseDose: "2 x 10 per side", beginnerDose: "2 x 6 per side", eliteDose: "1 x 10 per side" },
  { slug: "wu_rhythm_ball_tap", name: "Rhythm ball tap", role: "weightless_coordination", setup: "bounce a tennis ball to a metronome or beat", cue: "same spot every bounce — no chasing", gameDayLegal: true, minLifecycle: "beginner", source: "internal", baseDose: "2 x 30 sec", beginnerDose: "2 x 20 sec", eliteDose: "1 x 30 sec" },
  { slug: "wu_mini_frisbee_toss", name: "Mini frisbee toss and catch", role: "weightless_coordination", cue: "soft throw, read the spin, clean catch", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "2 x 10", beginnerDose: "2 x 6", eliteDose: "1 x 10" },
  { slug: "wu_mini_frisbee_roll_catch", name: "Mini frisbee roll catch", role: "weightless_coordination", cue: "roll it, let it spin, catch it on the return", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "2 x 8", beginnerDose: "2 x 5", eliteDose: "1 x 8" },
  ...
  { slug: "wu_light_bat_shadow_tap", name: "Light bat shadow tap", role: "weightless_coordination", setup: "light bat or dowel", cue: "tap the end of the bat to the wall with the eyes tracking", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "2 x 10 per side", beginnerDose: "2 x 6 per side", eliteDose: "1 x 10 per side" },
  { slug: "wu_shuttle_tap_up", name: "Badminton shuttle tap-up", role: "weightless_coordination", cue: "tap the shuttle straight up — no sideways drift", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "2 x 20 sec", beginnerDose: "2 x 15 sec", eliteDose: "1 x 20 sec" },
  { slug: "wu_partner_alternating_catch", name: "Partner alternating rapid catch", role: "weightless_coordination", setup: "two balls, two partners", cue: "catch one, toss the other — no gaps", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "2 x 30 sec", beginnerDose: "2 x 20 sec", eliteDose: "1 x 30 sec" },

  // Movement bridge
  { slug: "wu_dry_swing_progressive", name: "Progressive dry swings (intent ladder)", role: "movement_bridge", cue: "swing 1 at 50%, swing 2 at 75%, swing 3 at 100% — feel the elastic snap", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "3 x 3 per side" },
  { slug: "wu_mirror_throw_prep", name: "Dry throw arm-swing prep", role: "movement_bridge", cue: "half-speed rehearsal — pattern first, intent last", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "2 x 6" },
  { slug: "wu_shuffle_change_direction", name: "Shuffle → change of direction", role: "movement_bridge", cue: "athletic stance, react like a defender", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "2 x 20 sec each way" },
  { slug: "wu_crossover_run", name: "Crossover run (open the hip)", role: "movement_bridge", cue: "cross over long, don't hop", gameDayLegal: true, minLifecycle: "beginner", source: "internal", baseDose: "2 x 15 yds each way" },

  // Arm care
  { slug: "wu_jband_full", name: "Arm-care band chart", role: "arm_care", setup: "arm-care band anchored at chest height", cue: "control the eccentric — every rep", stopIf: "shoulder sharp pain", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "full chart @ 1 x 10 each" },
  { slug: "wu_crossover_symmetry_full", name: "Band activation chart", role: "arm_care", cue: "smooth reps, exhale on pull", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "full chart @ 1 x 10 each" },
  { slug: "wu_prone_tyw", name: "Prone T / Y / W", role: "arm_care", cue: "thumbs up, squeeze the shoulder blades", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "2 x 8 each letter" },
  { slug: "wu_er_at_90", name: "External rotation at 90°", role: "arm_care", setup: "band anchored elbow height", cue: "elbow high, slow eccentric", gameDayLegal: true, minLifecycle: "beginner", source: "internal", baseDose: "2 x 12 per side" },
  { slug: "wu_scap_pushup", name: "Scapular push-up", role: "arm_care", cue: "protract/retract only — no elbow bend", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "2 x 10" },
  { slug: "wu_face_pull_band", name: "Band face pull", role: "arm_care", setup: "band at eye level", cue: "elbows high, pull the band apart, external rotate", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "2 x 12" },
  { slug: "wu_forearm_pump", name: "Forearm flexor/extensor pump", role: "arm_care", cue: "band or light weight, high reps to flush", gameDayLegal: true, minLifecycle: "youth", source: "internal", baseDose: "1 x 20 each direction" },
];
