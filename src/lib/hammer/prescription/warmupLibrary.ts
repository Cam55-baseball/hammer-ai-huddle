...
export const WARMUP_LIBRARY: WarmupDrill[] = [
  ...
  { slug: "wu_scarf_cross_body_catch", name: "Scarf cross-body catch", role: "weightless_coordination", cue: "reach long across the body — hips stay square", gameDayLegal: true, minLifecycle: "youth", source: "WOST", baseDose: "2 x 8 per side", beginnerDose: "2 x 5 per side", eliteDose: "1 x 8 per side" },
