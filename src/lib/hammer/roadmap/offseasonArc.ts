// Browser mirror of supabase/functions/_shared/wic/schedule/timeline/offseasonArc.ts
// Everything below the first line is byte-identical to the server file (see
// src/test/timeline/arcMirror.test.ts). Edit the server file, then re-copy.
//
