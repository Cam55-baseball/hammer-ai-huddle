...
export const STANDARDS: readonly StandardDef[] = [
  ...
  },
  {
    ...
    slugs: ["lift_patrick_step", "backward_step_down_heel_elevated", "box_step_up"],
    metric: "reps",
  ...
  },
  {
    ...
    slugs: ["rdl_concentric", "rdl_double_ecc", "lift_rdl_cluster", "lift_snatch_grip_rdl", "snatch_grip_rdl", "rdl_db"],
    metric: "load_pct_bw_at_reps",
    reps: 10,
    minTrainingAge: "developing",
    minAgeYears: 15,
  ...
  // ---------------------------------------------------------- relative strength
  {
    ...
    slugs: ["trap_bar_deadlift", "trap_bar_dl_double_ecc", "lift_chain_deadlift", "lift_band_deadlift", "lift_deficit_deadlift"],
    metric: "load_pct_bw_at_reps",
    reps: 1,
    minTrainingAge: "advanced",
    minAgeYears: 16,
  ...
  },
  {
    ...
    slugs: ["lift_safety_bar_squat", "lift_box_squat_wide", "ws_max_effort_box_squat", "safety_bar_box_squat", "lift_paused_front_squat", "lift_tempo_back_squat", "zercher_squat"],
    metric: "load_pct_bw_at_reps",
    reps: 1,
    minTrainingAge: "advanced",
    minAgeYears: 16,
  ...
  },
  {
    ...
    slugs: ["bench_press_concentric", "bench_press_double_ecc", "pause_bench", "ws_max_effort_bench_board", "lift_swiss_bar_bench", "db_bench"],
    metric: "load_pct_bw_at_reps",
    reps: 1,
    minTrainingAge: "advanced",
    minAgeYears: 16,
  ...
  },
  {
    ...
    slugs: [
      "lift_safety_bar_squat", "lift_box_squat_wide", "ws_max_effort_box_squat", "safety_bar_box_squat", "lift_paused_front_squat", "zercher_squat",
      "trap_bar_deadlift", "trap_bar_dl_double_ecc", "lift_chain_deadlift", "lift_band_deadlift", "lift_deficit_deadlift",
      "bench_press_concentric", "bench_press_double_ecc", "pause_bench", "ws_max_effort_bench_board", "lift_swiss_bar_bench",
    ],
  ...
  // ---------------------------------------------------------- rotational power
  {
    ...
    slugs: ["med_ball_shot_put", "wu_med_ball_shot_put", "dl_med_ball_shotput", "med_ball_scoop_toss", "wu_med_ball_scoop_toss", "rotational_med_ball_scoop"],
    metric: "distance_ft",
    minTrainingAge: "beginner",
    minAgeYears: 14,
