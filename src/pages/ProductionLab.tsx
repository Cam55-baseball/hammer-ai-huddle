...
import { FlaskConical, Lock, Dumbbell, Zap } from "lucide-react";
...
export default function ProductionLab() {
  ...
  const hasAccess = hasSubModuleAccess('production_lab', 'pitching', selectedSport);
  ...
  useEffect(() => {
    if (!authLoading && !subLoading && !hasAccess) {
      toast({
        ...
        description: `Subscribe to the ${selectedSport} Pitching Module to access Production Lab.`,
        variant: "destructive",
      });
      navigate('/pricing');
    }
  ...
  const initializeProgram = async () => {
    try {
      ...
      toast({
        title: "Welcome to Production Lab!",
        ...
        <div className="min-h-screen flex items-center justify-center p-4">
          <Card className="max-w-md w-full p-8 text-center space-y-4">
            ...
            <p className="text-muted-foreground">
              Subscribe to the {selectedSport} Pitching Module to access Production Lab.
            </p>
      ...
      <div className="container max-w-7xl mx-auto p-4 sm:p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold">Production Lab</h1>
              <p className="text-sm text-muted-foreground">Pitching Power Development</p>
            </div>
          </div>
