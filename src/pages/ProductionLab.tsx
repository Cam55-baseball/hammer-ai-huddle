...
const HITTING_WEEKS: WeekData[] = [
  {
    ...
    days: [
      { day: 'day1', title: 'Day 1: Stance Setup', exercises: ['Athletic stance drill', 'Balance check', 'Grip pressure test', 'Bat waggle speed drill'].map(getExercise) },
      ...
      { day: 'day3', title: 'Day 3: Tee Work Basics', exercises: ['Center tee - 25 swings', 'Inside tee - 15 swings', 'Outside tee - 15 swings', 'Speed swings - 10 reps'].map(getExercise) },
      { day: 'day4', title: 'Day 4: Soft Toss', exercises: ['Front toss - 30 reps', 'Side toss - 20 reps', 'Focus on contact point', 'Quick hands drill'].map(getExercise) },
  ...
  },
  {
    ...
    days: [
      { day: 'day1', title: 'Day 1: Load Sequence', exercises: ['Negative move drill', 'Stride timing', 'Weight back drill', 'Bat behind back rotations'].map(getExercise) },
      ...
      { day: 'day3', title: 'Day 3: Separation', exercises: ['Hip-shoulder separation', 'Rubber band drill', 'Torque creation', 'Connection ball drill'].map(getExercise) },
      { day: 'day4', title: 'Day 4: Live Timing', exercises: ['Front toss timing', 'Machine work', 'Variable speeds', 'Speed tee work - 15 swings'].map(getExercise) },
  ...
  },
  {
    ...
    days: [
      { day: 'day1', title: 'Day 1: Hip Mechanics', exercises: ['Hip rotation isolation', 'Ground force drill', 'Core activation', 'One-handed speed swings'].map(getExercise) },
      ...
      { day: 'day3', title: 'Day 3: Connection', exercises: ['Hip-hand connection', 'Barrel lag drill', 'Sequence work', 'Wrist snap drill'].map(getExercise) },
  ...
  },
  {
    ...
    days: [
      { day: 'day1', title: 'Day 1: Plane Work', exercises: ['Bat path visualization', 'Swing plane drill', 'Level through zone', 'Resistance band speed swings'].map(getExercise) },
      ...
      { day: 'day3', title: 'Day 3: Extension', exercises: ['Extension through ball', 'Follow through work', 'Finish position', 'Speed swings - 10 reps'].map(getExercise) },
      { day: 'day4', title: 'Day 4: Adjustability', exercises: ['High pitch adjustment', 'Low pitch adjustment', 'In-zone coverage', 'Swing speed measurement'].map(getExercise) },
  ...
  },
  {
    ...
    days: [
      { day: 'day1', title: 'Day 1: Bat Speed Drills', exercises: ['Overload/underload protocol', 'Speed chains', 'Intent swings', 'Quick hands drill'].map(getExercise) },
      ...
      { day: 'day3', title: 'Day 3: Strength Transfer', exercises: ['Med ball rotations', 'Power position holds', 'Explosive movements', 'One-handed speed swings'].map(getExercise) },
      { day: 'day4', title: 'Day 4: Game Power', exercises: ['Situational power', 'Driving the ball', 'Hard contact focus', 'Swing speed measurement'].map(getExercise) },
  ...
  },
  {
    ...
    days: [
      { day: 'day1', title: 'Day 1: Approach Work', exercises: ['Count-based approach', 'Pitch selection', 'Zone discipline', 'Bat waggle speed drill'].map(getExercise) },
      ...
      { day: 'day3', title: 'Day 3: Velocity Training', exercises: ['High velocity machine', 'Reaction time', 'Quick decisions', 'Speed swings - 10 reps'].map(getExercise) },
      { day: 'day4', title: 'Day 4: Live At-Bats', exercises: ['Simulated game ABs', 'Pressure situations', 'Compete mode', 'Swing speed measurement'].map(getExercise) },
