    ...
    return (
      <DashboardLayout>
        <div className="p-4 sm:p-6 text-center max-w-md mx-auto mt-12">
          ...
          <h1 className="text-xl font-bold mb-2">Explosive Conditioning</h1>
          <p className="text-muted-foreground mb-4">
            Explosive Conditioning unlocks with the Complete Pitcher module. Subscribe to start your speed journey.
          </p>
            ...
            <CardContent className="pt-8 pb-8 flex flex-col items-center gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Build elite speed with structured training, recovery science, and professional drills.
                </p>
              </div>
              <Button
      ...
      <div className="p-3 sm:p-6 max-w-4xl mx-auto space-y-4 sm:space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Build elite speed, protect your body
              </p>
            </div>
          </div>
            ...
            {isLocked && unlockTime ? (
              ...
              <div className="text-center py-4">
                <p className="text-sm text-muted-foreground mb-1">
                  {sessionFocus.icon} {FOCUS_MESSAGE_FALLBACKS[sessionFocus.messageKey] || ''}
                </p>
                <Button
                  onClick={() => setInSession(true)}
        ...
        <div className="bg-muted/30 rounded-lg p-3 text-center">
          <p className="text-[10px] text-muted-foreground">
            Always consult with a qualified healthcare professional before beginning any exercise program. Listen to your body and stop immediately if you experience pain.
          </p>
        </div>
      </div>
    </DashboardLayout>
