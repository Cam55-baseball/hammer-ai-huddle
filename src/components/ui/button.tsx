  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-[0_20px_40px_-15px_hsl(0_100%_50%/0.3)] hover:shadow-[0_0_40px_hsl(0_100%_50%/0.4)] hover:scale-[1.02]",
        role: "bg-card border-2 border-border text-foreground hover:border-primary hover:shadow-[0_0_30px_hsl(0_100%_50%/0.2)] hover:scale-[1.02] min-h-[120px] flex-col gap-3",
      },
      size: {
        default: "h-10 px-4 py-2 min-h-[44px]",
        sm: "h-9 rounded-md px-3 min-h-[44px]",
        lg: "h-11 rounded-md px-8 min-h-[44px]",
        xl: "h-14 rounded-lg px-10 text-base min-h-[44px]",
