...
export function IdentityBanner({ className }: Props) {
  ...
  return (
    <div className={cn('space-y-2', className)}>
      <div
        className={cn(
          'relative overflow-hidden rounded-2xl border bg-gradient-to-br p-4 ring-2',
          bg,
          ring
        )}
      >
        <div className="flex items-center justify-between gap-4">
          <div className="min-w-0 flex-1">
            <div className="text-[10px] font-semibold uppercase tracking-[0.2em] text-zinc-700">
              Identity
            </div>
            ...
            <div className="mt-2 flex flex-wrap items-center gap-2 text-xs">
              <span className="inline-flex items-center gap-1 rounded-full bg-white/80 px-2 py-0.5 font-semibold text-zinc-900 border border-zinc-300">
              ...
              {snapshot && snapshot.nn_miss_count_7d > 0 && (
                <span className="inline-flex items-center gap-1 rounded-full bg-rose-200 px-2 py-0.5 font-semibold text-rose-900 border border-rose-400">
          ...
          <div className="flex flex-col items-end">
            ...
            <div className="text-[10px] font-semibold uppercase tracking-widest text-zinc-700">
              Consistency
            </div>
          </div>
        </div>
