        ...
        <div className="flex items-center gap-2">
          {!isSelecting ? (
            ...
            >
              ...
              {t('workoutBuilder.superset.createSuperset', 'Create Superset')}
            </Button>
          ) : (
            <>
              <span className="text-xs text-muted-foreground">
                {t('workoutBuilder.superset.selectExercises', 'Select 2-3 exercises')} ({selectedIds.length}/3)
              </span>
              <Button 
                variant="default" 
                size="sm" 
                ...
                {exercises.map((exercise, index) => {
                  ...
                  return (
                    <div key={exercise.id} className="relative">
                      ...
                      {supersetInfo?.isLast && (
                        <div className="absolute -bottom-3 left-8 right-8 flex items-center justify-center">
