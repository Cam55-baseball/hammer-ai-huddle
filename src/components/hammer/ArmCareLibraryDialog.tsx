...
const FAMILIES: { key: string; label: string }[] = [
  ...
  { key: "jaeger_jband", label: "Band Series" },
  { key: "xband", label: "Cross-Band Series" },
  { key: "jobes", label: "Classic Shoulder Set" },
  { key: "crossover_symmetry", label: "Crossover Bands" },
  { key: "cressey", label: "Shoulder Prep" },
  { key: "driveline", label: "Weighted-Ball Care" },
  { key: "oates", label: "Shoulder Tube" },
