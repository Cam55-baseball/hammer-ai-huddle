...
export function HourlyForecastSection({ hourlyForecast }: HourlyForecastSectionProps) {
  ...
  return (
    <div className="space-y-3 animate-in fade-in-50 slide-in-from-top-2 duration-300">
      ...
      <div className="overflow-x-auto pb-2 -mx-4 px-4 scrollbar-hide snap-x snap-mandatory scroll-smooth"
           style={{ 
             scrollbarWidth: 'none', 
        ...
        <div className="flex gap-3" style={{ minWidth: 'max-content' }}>
          {forecastWithLabels.map(({ hour, index, showPeriodLabel, periodLabel }) => {
            ...
            return (
              <div key={hour.time} className="flex items-end gap-3 snap-start">
