...
export const GRADE_BENCHMARKS: BenchmarkTable = {
  ...
  tee_exit_velocity: {
    ...
    baseball: {
      ...
      '18u': [
        { raw: 60, grade: 20 }, { raw: 68, grade: 30 }, { raw: 79, grade: 45 },
        { raw: 85, grade: 55 }, { raw: 92, grade: 65 }, { raw: 100, grade: 80 },
      ],
      college: [
  ...
  bat_speed: {
    ...
    baseball: {
      ...
      '18u': [
        ...
        { raw: 67, grade: 55 }, { raw: 74, grade: 65 }, { raw: 82, grade: 80 },
      ],
      college: [
  ...
  position_throw_velo: {
    ...
    baseball: {
      ...
      '18u': [
        { raw: 55, grade: 20 }, { raw: 62, grade: 30 }, { raw: 71, grade: 45 },
        { raw: 77, grade: 55 }, { raw: 84, grade: 65 }, { raw: 92, grade: 80 },
      ],
      college: [
