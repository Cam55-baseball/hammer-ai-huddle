import type { OutcomeTag } from '../baseball/outcomeTags';

export const softballHittingOutcomes: OutcomeTag[] = [
  ...
  { id: 'slap_single', label: 'Slap Single', category: 'positive', color: 'green' },
  { id: 'drag_bunt', label: 'Drag Bunt', category: 'positive', color: 'green' },
  { id: 'power_slap', label: 'Power Slap', category: 'positive', color: 'green' },
  { id: 'soft_slap', label: 'Soft Slap', category: 'positive', color: 'green' },
  { id: 'hbp', label: 'HBP', category: 'neutral', color: 'yellow' },
];

export const softballPitchingOutcomes: OutcomeTag[] = [
  ...
  { id: 'illegal_pitch', label: 'Illegal Pitch', category: 'negative', color: 'red' },
  { id: 'drop_ball_strike', label: 'Drop Ball Strike', category: 'positive', color: 'green' },
  { id: 'rise_ball_chase', label: 'Rise Ball Chase', category: 'positive', color: 'green' },
];
