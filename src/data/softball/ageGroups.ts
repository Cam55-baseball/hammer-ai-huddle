/**
 * Youth-softball age groups.
 *
 * `multiplier` scales the base tier multiplier (e.g. Travel Ball) so that
 * playing up (14U in an 18U Gold bracket) or staying at 8U produces sane
 * weighting. A value of 1.0 is the neutral (natural age) baseline.
 */
...
export const softballAgeGroups: AgeGroup[] = [
  ...
  { key: '18u', label: '18U', multiplier: 1.12 },
  { key: '18u_gold', label: '18U Gold', multiplier: 1.20 },
];
