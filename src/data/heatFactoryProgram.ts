...
export const CYCLE_1_PITCHING_WORKOUT_C: Exercise[] = [
  ...
  { name: 'Box Squat', type: 'strength', sets: 4, reps: 5, percentOf1RM: 72, trackWeight: true,
    description: 'Sit back to box, explode up. Teaches rate of force development from dead stop.',
    notes: 'Dead stop start, no momentum' },
  { name: 'Incline Dumbbell Press', type: 'strength', sets: 4, reps: 6, percentOf1RM: 70, trackWeight: true,
...
export const CYCLE_1_PITCHING_WORKOUT_D: Exercise[] = [
  // Full Body - Sumo Focus
  { name: 'Sumo Deadlift', type: 'strength', sets: 4, reps: 5, percentOf1RM: 72, trackWeight: true,
    description: 'Wide stance pulling for hip and adductor strength. Hip power development.',
    notes: 'Wide stance, hips through' },
  { name: 'Walking Lunge', type: 'strength', sets: 3, reps: 6, percentOf1RM: 65, trackWeight: true,
...
export const CYCLE_2_PITCHING_WORKOUT_A: Exercise[] = [
  // Full Body - Heavy Trap Bar Focus
  ...
  { name: 'Back Squat', type: 'strength', sets: 4, reps: 4, percentOf1RM: 80, trackWeight: true,
    description: 'Heavy squatting for leg strength. Deep depth with controlled descent.',
...
export const CYCLE_2_PITCHING_WORKOUT_D: Exercise[] = [
  ...
  { name: 'Dumbbell Shoulder Press', type: 'strength', sets: 3, reps: 6, percentOf1RM: 72, trackWeight: true,
    description: 'Shoulder strength for arm acceleration.',
...
export const CYCLE_3_PITCHING_WORKOUT_A: Exercise[] = [
  // Full Body - Deficit Deadlift Focus
...
export const CYCLE_3_PITCHING_WORKOUT_D: Exercise[] = [
  ...
  { name: 'Single-Arm Dumbbell Row', type: 'strength', sets: 4, reps: 5, percentOf1RM: 75, trackWeight: true,
    description: 'Heavy unilateral pulling with anti-rotation demand.',
    notes: 'Each arm, no torso rotation' },
...
export const CYCLE_4_PITCHING_WORKOUT_D: Exercise[] = [
  // Full Body - Peak Hip Thrust Focus
  ...
  { name: 'Single-Arm Dumbbell Row', type: 'strength', sets: 3, reps: 5, percentOf1RM: 75, trackWeight: true,
    description: 'Unilateral back strength maintenance.',
    notes: 'Each arm, strict form' },
